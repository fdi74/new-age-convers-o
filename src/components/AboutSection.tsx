...
const AboutSection = () => {
  return (
    <section className="py-24 md:py-32 bg-gradient-dark text-cream">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <h2 className="font-display text-4xl md:text-5xl font-light leading-tight mb-6">
              Tecnologia e{" "}
              <span className="text-gradient-gold italic font-medium">humanização</span>{" "}
              em cada consulta
            </h2>
            <p className="font-body text-cream-dark/70 text-lg leading-relaxed mb-8">
              A New Age Derma BC é referência em dermatologia e estética avançada em 
              Balneário Camboriú. Combinamos tecnologia de última geração com 
              atendimento humanizado para entregar resultados naturais e duradouros.
            </p>
            ...
            <div className="grid grid-cols-3 gap-6 mb-10">
              {stats.map((stat) => (
                <div key={stat.label} className="text-center">
                  ...
                  <div className="font-display text-2xl md:text-3xl font-semibold text-gold">
                    {stat.value}
                  </div>
            ...
            <a
              ...
              className="bg-gradient-gold text-primary-foreground font-body font-medium px-8 py-4 rounded-full inline-flex items-center gap-3 shadow-gold hover:scale-105 transition-transform duration-300"
            >
